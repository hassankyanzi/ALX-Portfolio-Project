  ...
  return (
    <div className="mx-auto max-w-5xl px-2 md:px-4">
      <nav className="flex justify-between text-white items-center">
        <Link
          to="/"
          className="p-2 md:p-4 inline-block hover:opacity-60 transition-opacity duration-200"
        >
          <svg
        ...
        <ul className="gap-2 md:gap-4 hidden md:flex">
          <li>
            <Link
              to="/"
              className="p-2 md:p-4 inline-block hover:opacity-60 transition-opacity duration-200"
        ...
        <svg
          ...
          width="24px"
          fill="currentColor"
          className="inline-block cursor-pointer md:hidden w-10 h-10"
      ...
      <div
        className={
          (sidebarOpen ? "mr-0" : "") +
          " fixed -mr-96 p-4 bg-white text-black top-0 right-0 h-screen w-full md:hidden max-w-96 transition-all ease-out duration-200"
        }
      >
        <div className="text-right">
          <svg
            ...
            width="24px"
            fill="currentColor"
            className="w-6 h-6 cursor-pointer inline-block hover:opacity-60 transition duration-200"
            onClick={() => setSidebarOpen(!sidebarOpen)}
          >
        ...
        <div className="mt-auto absolute left-4 bottom-4 flex gap-4">
          <a
            href="twitter.com"
            className="inline-block hover:opacity-60 transition-opacity duration-200"
          >
